...
import uz.sevimli.tzd.databinding.ActivitySalesReturnBinding
...
class SalesReturnActivity : AppCompatActivity() {
    ...
    private lateinit var b: ActivitySalesReturnBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b = ActivitySalesReturnBinding.inflate(layoutInflater)
    ...
    private fun finishDocument() {
        ...
        if (cpId < 0) {
            Toast.makeText(this, getString(R.string.client_not_set), Toast.LENGTH_SHORT).show(); return
        }
        AlertDialog.Builder(this)
            .setTitle(getString(R.string.sales_return_kt))
            .setMessage(getString(R.string.confirm_ship_fmt, cpName, items.size, trimNum(items.sumOf { it.quantity })))
