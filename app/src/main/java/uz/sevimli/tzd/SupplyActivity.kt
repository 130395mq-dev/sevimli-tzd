...
class SupplyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // yuqoridagi kichkina belgiga bir qo'lda yetish qiyin edi.
    ...
    private fun askQuantity(product: JSONObject, code: String) {
        ...
        // Приёмка uchun KIRIM (закупочная) narxi.
        //
        ...
        // MoySklad приёмка hujjatiga yozilardi.
        //
    ...
    private fun finishDocument() {
        ...
        AlertDialog.Builder(this)
            .setTitle(getString(R.string.supply_finish_kt))
    ...
    private fun confirmExit() {
        ...
        AlertDialog.Builder(this)
            ...
            .setMessage(getString(R.string.draft_note))
