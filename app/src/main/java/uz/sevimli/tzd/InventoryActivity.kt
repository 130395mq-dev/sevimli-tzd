...
import uz.sevimli.tzd.databinding.ActivityInventoryBinding
...
/**
 * Инвентаризация (sanoq). Приёмкаga o'xshaydi, lekin kontragent yo'q —
 * hujjat qurilmaga biriktirilgan sklad bo'yicha yoziladi. Har mahsulotning
 * haqiqiy (fakt) soni sanaladi, tizim qoldig'i bilan farqni MoySklad hisoblaydi.
 */
class InventoryActivity : AppCompatActivity() {
    ...
    private fun finishDocument() {
        ...
        AlertDialog.Builder(this)
            .setTitle(getString(R.string.inventory_finish))
    ...
    private fun sendDocument() {
        ...
        thread {
            val result = Api.post(this, "inventory", body)
            runOnUiThread {
